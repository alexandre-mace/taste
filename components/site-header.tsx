    ...
    <header className="sticky top-0 z-40 border-b bg-background/90 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3.5 sm:px-6">
        <div className="flex min-w-0 items-center gap-3 sm:gap-4">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger className="flex min-w-0 items-center gap-1.5 border-b border-transparent pb-0.5 font-mono text-[11px] tracking-wider text-muted-foreground uppercase transition-colors outline-none hover:text-foreground focus-visible:border-ring aria-expanded:text-foreground">
